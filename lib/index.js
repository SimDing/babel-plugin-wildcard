    ...
    return {
        visitor: {
            ImportDeclaration: function ImportDeclaration(path, state) {
                ...
                var isExplicitWildcard = /\/\*$/.test(src);
                ...
                for (var i = 0; i < node.specifiers.length; i++) {
                    ...
                    if (t.isImportNamespaceSpecifier(dec) && !_fs3.default.statSync(dir).isFile()) {
                        addWildcard = true;
                ...
                if (addWildcard) {
                    ...
                    try {
                        ...
                        for (var i = 0; i < r.length; i++) {
                            ...
                            if (exts.indexOf(_path3.default.extname(r[i]).substring(1)) > -1) {
                                files.push(r[i]);
                            }
                        }
                    } catch (e) {
